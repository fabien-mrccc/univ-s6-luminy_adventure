...
## Called every frame, checks for window mode changes
...
## Change to the main world scene when back button is pressed
...
## Toggle grass visibility in the world
...
## Change screen/window mode and center window on screen
...
## Center the game window on the user's screen
...
## Adjust the player sensitivity setting
